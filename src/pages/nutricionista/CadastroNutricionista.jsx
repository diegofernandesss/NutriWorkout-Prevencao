...
import { useCadastro } from '../../hooks/nutricionista/useCadastro';

export const CadastroNutricionista = () => {
      ...
      <div className='bg-gray-100 pt-20 flex items-center justify-center'>
        <div className='bg-gray-200 flex rounded-2xl shadow-lg max-w-3xl p-5'>
          <div className='sm:w-3/4 px-16'>
            <h2 className='font-bold text-2xl'>Cadastro Nutricionista</h2>
            ...
            <CustomInput
              ...
              <CustomInput
                ...
                onBlur={formik.handleBlur}
                onChange={formik.handleChange}
                error={formik.touched.crn && formik.errors.crn ? formik.errors.crn : null}
                isFirstInput={false}
              />
              <CustomInput
                id="senha"
