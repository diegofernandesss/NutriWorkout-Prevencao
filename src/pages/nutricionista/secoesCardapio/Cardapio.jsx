              ...
              {cardapio.map((cardapio) => (
                <tr key={cardapio.id} className="bg-white border-b hover:bg-gray-100">
                  ...
                  <td className="px-2 py-4 flex flex-row gap-4">
                    <button onClick={() => handleDeleteClick(cardapio.id)} className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-700 transition duration-150 ease-in-out hover:bg-red-600 bg-red-700 rounded text-white px-8 py-2 text-sm focus:border-red-700" >Deletar Cardápio</button>
                    <button onClick={() => handleAddModal(cardapio.id)} className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-700 transition duration-150 ease-in-out hover:bg-orange-600 bg-orange-700 rounded text-white px-8 py-2 text-sm focus:border-orange-700" >Atualizar Cardápio</button>
                  </td>
                </tr>
              ))}
            </tbody>
